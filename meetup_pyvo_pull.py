...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--id', dest='meetup_id', type=str,
                        required=True, help='Id of the meetup on meetup.com')
    ...
    if not os.path.isfile(os.path.join(DIR, 'cities', args.city, 'venues',
                          args.venue + '.yaml')):
    ...
    dest_file_name = os.path.join(DIR, 'series', args.serie, 'events',
                                  event_file_name)

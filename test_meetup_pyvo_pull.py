import pytest
from meetup_pyvo_pull import (process_start, process_description,
                              remove_diacritic, get_meetup_data,
...
@pytest.mark.parametrize('group, meetup_id, name, venue_name, group_name',
                         testdata)
...
@pytest.mark.parametrize('group, meetup_id, name, venue_name, group_name',
                         testdata)
def test_load_and_fill_template(group, meetup_id, name, venue_name,
                                group_name):
